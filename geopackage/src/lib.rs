...
pub enum ContentsDataType {
    ...
    /// Tile pyramid.
    Tiles,
    /// Tiled gridded coverage: a tile pyramid whose payloads carry
    /// measurements rather than pictures (`2d-gridded-coverage`,
    /// OGC 17-066r2 Requirement 5).
    ///
    /// Opened with [`GeoPackage::coverage`], never with
    /// [`GeoPackage::tiles`].
    Coverage,
